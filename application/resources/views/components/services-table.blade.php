        ...
        @forelse($entries as $entry)
            <tr tabindex="0"
                ...
                <form data-id="{{ $entry->id }}"
                      ...
                      action="{{ route('admin.service.delete', ['id' => $entry->id]) }}"
                      method="POST">
                    @csrf
                    @method('DELETE')
                    <td class="pl-4 text-right">
                        @if ($entry->status === 'DRAFT')
                            <a class="focus:ring-2 focus:ring-offset-2 focus:ring-emerald-300 text-sm leading-none text-gray-50 py-3 px-5 mx-0.5 bg-emerald-500 rounded hover:bg-emerald-600 focus:outline-none cursor-pointer publish-item"
                               data-url={{ route('admin.service.save', ['id' => $entry->id]) }}
                               data-id="{{ $entry->id }}"
                               data-method="POST"
                        ...
                        @endif
                        <a href="{{ route('admin.service.gallery', ['id' => $entry->id]) }}"
                           class="focus:ring-2 focus:ring-offset-2 focus:ring-blue-950 text-sm leading-none text-gray-600 py-3 px-5 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">Gerir
                            Imagens</a>
                        <a href="{{ route('admin.service.show', ['id' => $entry->id]) }}"
                        ...
                        <button href="#"
                                ...
                                data-method="DELETE"
                                data-url="{{ route('admin.service.delete', ['id' => $entry->id]) }}"
                                data-id="{{ $entry->id }}"
                                class="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-50 py-3 px-5 mx-0.5 bg-red-400 rounded hover:bg-red-500 focus:outline-none confirm-service-delete">Apagar</a>
                    </td>
                </form>
            </tr>
            <tr class="h-3"></tr>
