<div class="mx-auto mt-6 max-w-2xl sm:px-6 lg:grid lg:max-w-7xl lg:gap-x-8 lg:px-8">
    ...
    <div class="flex flex-col justify-start items-start w-full space-y-8">
        ...
        <div class="w-full flex justify-start items-start flex-col bg-gray-50 dark:bg-gray-800 p-8">
            <div class="justify-between w-full mb-10">
                <textarea id="message"
                          rows="4"
                ...
                <div class="flex justify-end">
                    <button
                            class="my-10 text-right bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Enviar
                        comentário</button>
                </div>
            </div>
            <div class="flex flex-col md:flex-row justify-between w-full border-t border-gray-400 pt-5">
            ...
            <div id="menu"
                ...
                <div class="mt-6 flex justify-start items-center flex-row space-x-2.5">
                    <div>
                        <img src="https://i.ibb.co/QcqyrVG/Mask-Group.png"
                             alt="girl-avatar" />
                    </div>
            ...
            <div class="w-full flex justify-start items-start flex-col bg-gray-50 dark:bg-gray-800 md:px-8 py-8">
                ...
                <div id="menu2"
                    ...
                    <div class="mt-6 flex flex-row justify-start items-start space-x-4">
                        ...
                        <div class="py-4 px-8 bg-gray-100">
                            <img src="https://i.ibb.co/54F7vvV/Group-1855.png"
                                 alt="chair-6" />
                        </div>
                    </div>
                    <div class="mt-6 flex justify-start items-center flex-row space-x-2.5">
                        <div>
                            <img src="https://i.ibb.co/RCTGZTc/Mask-Group-1.png"
                                 alt="girl-avatar" />
                        </div>
                        <div class="flex flex-col justify-start items-start space-y-2">
