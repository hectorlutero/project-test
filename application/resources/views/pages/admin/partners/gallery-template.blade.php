                ...
                <div class="mb-10 sm:mb-0 mt-10 grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div
                        ...
                        <img class="w-20 h-20 object-cover object-center rounded-full"
                             ...
                             alt="cuisine" />
                        <h4 class="text-white text-2xl font-bold capitalize text-center">Empresas</h4>
                    ...
                    <div
                        ...
                        <img class="w-20 h-20 object-cover object-center rounded-full"
                             ...
                             alt="art" />
                        <h4 class="text-white text-2xl font-bold capitalize text-center">Produtos</h4>
                    ...
                    <div
                        ...
                        <img class="w-20 h-20 object-cover object-center rounded-full"
                             ...
                             alt="gaming" />
                        <h4 class="text-white text-2xl font-bold capitalize text-center">Serviços</h4>
                        <p class="text-white/50">207 members</p>
                        <p class="absolute top-2 text-white/20 inline-flex items-center text-xs">0 Online <span
                                  class="ml-2 w-2 h-2 block bg-red-400 rounded-full group-hover:animate-pulse"></span>
                        </p>
                    </div>
                    <div
                         class="relative group bg-gray-900 py-10 sm:py-20 px-4 flex flex-col space-y-2 items-center cursor-pointer rounded-md hover:bg-gray-900/80 hover:smooth-hover">
                        <img class="w-20 h-20 object-cover object-center rounded-full"
                             ...
                             alt="cinema" />
                        <h4 class="text-white text-2xl font-bold capitalize text-center">Usuários</h4>
                    ...
                    <div
                        ...
                        <img class="w-20 h-20 object-cover object-center rounded-full"
                             ...
                             alt="song" />
                        <h4 class="text-white text-2xl font-bold capitalize text-center">Plataforma</h4>
                    ...
                    <div
                        ...
                        <img class="w-20 h-20 object-cover object-center rounded-full"
                             ...
                             alt="code" />
                        <h4 class="text-white text-2xl font-bold capitalize text-center">Relatórios</h4>
                    ...
                    <div
                        ...
                        <img class="w-20 h-20 object-cover object-center rounded-full"
                             ...
                             alt="dancing" />
                        <h4 class="text-white text-2xl font-bold capitalize text-center">Arquivos</h4>
