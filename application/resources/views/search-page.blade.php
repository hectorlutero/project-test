          ...
          -->
                        <div
                            ...
                            <form class="mt-4 border-t border-gray-200">
                                ...
                                <ul role="list"
                                    ...
                                    <li>
                                        <a href="#"
                                           class="block px-2 py-3">Totes</a>
                                    </li>

                                    <li>
                                        <a href="#"
                                           class="block px-2 py-3">Backpacks</a>
                                    </li>

                                    <li>
                                        <a href="#"
                                           class="block px-2 py-3">Travel Bags</a>
                                    </li>

                                    <li>
                                        <a href="#"
                                           class="block px-2 py-3">Hip Bags</a>
                                    </li>

                                    <li>
                                        <a href="#"
                                           class="block px-2 py-3">Laptop Sleeves</a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="pt-6"
                                        ...
                                        <div class="space-y-6">
                                            <div class="flex items-center">
                                                <input id="filter-mobile-color-0"
                                                       name="color[]"
                                                       value="white"
                                                       type="checkbox"
                                            ...
                                            <div class="flex items-center">
                                                <input id="filter-mobile-color-1"
                                                       name="color[]"
                                                       value="beige"
                                                       type="checkbox"
                                                       class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            ...
                                            <div class="flex items-center">
                                                <input id="filter-mobile-color-2"
                                                       name="color[]"
                                                       value="blue"
                                                       type="checkbox"
                                                       checked
                                            ...
                                            <div class="flex items-center">
                                                <input id="filter-mobile-color-3"
                                                       name="color[]"
                                                       value="brown"
                                                       type="checkbox"
                                                       class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            ...
                                            <div class="flex items-center">
                                                <input id="filter-mobile-color-4"
                                                       name="color[]"
                                                       value="green"
                                                       type="checkbox"
                                                       class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            ...
                                            <div class="flex items-center">
                                                <input id="filter-mobile-color-5"
                                                       name="color[]"
                                                       value="purple"
                                                       type="checkbox"
                                                       class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                ...
                                <div class="border-t border-gray-200 px-4 py-6">
                                    <h3 class="-mx-2 -my-3 flow-root">
                                        <!-- Expand/collapse section button -->
                                        <button type="button"
                                                class="sidebar-dropdown flex w-full items-center justify-between bg-white px-2 py-3 text-gray-400 hover:text-gray-500"
                                        ...
                                        <div class="space-y-6">
                                            <div class="flex items-center">
                                                ...
                                                <label for="filter-mobile-category-0"
                                                       class="ml-3 min-w-0 flex-1 text-gray-500">Encontre o que você
                                                    está precisando</label>
                                            </div>

                                            <div class="flex items-center">
                                                <input id="filter-mobile-category-1"
                                                       name="category[]"
                                                       value="sale"
                                                       type="checkbox"
                                                       class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                            ...
                                            <div class="flex items-center">
                                                <input id="filter-mobile-category-2"
                                                       name="category[]"
                                                       value="travel"
                                                       type="checkbox"
                                                       checked
                                            ...
                                            <div class="flex items-center">
                                                <input id="filter-mobile-category-4"
                                                       name="category[]"
                                                       value="accessories"
                                                       type="checkbox"
                                                       class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                ...
                <main class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
                        <h1 class="text-4xl font-bold tracking-tight text-gray-900">Encontre o que você
                            está precisando</h1>
              ...
              -->
                                <div class="absolute right-0 z-10 mt-2 w-40 origin-top-right rounded-md bg-white shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none transform opacity-0 scale-95"
                                     role="menu"
                  ...
                  -->
                                        ...
                                        <a href="#"
                                           class="text-gray-500 bg-gray-100/0 hover:bg-gray-100 ease-in-out duration-200 block px-4 py-2 text-sm"
                                           role="menuitem"
                                           tabindex="-1"
                                        ...
                                        <a href="#"
                                           class="text-gray-500 bg-gray-/0 hover:bg-gray-100 ease-in-out duration-200 block px-4 py-2 text-sm"
                                           role="menuitem"
                                           tabindex="-1"
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                            ...
                            <form class="hidden lg:block">
                                ...
                                <div class="border-b border-gray-200 py-6">
                                    <h3 class="-my-3 flow-root">
                                        <!-- Expand/collapse section button -->
                                        <button type="button"
                                                class="sidebar-dropdown flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500"
                                                aria-controls="filter-section-0"
                                                aria-expanded="false">
                                            <span class="font-medium text-gray-900">Faixa de Preço</span>
                                            <span class="ml-6 flex items-center">
                                                <!-- Expand icon, show/hide based on section open state. -->
                                                <svg class="h-5 w-5 expand-icon"
                                                     viewBox="0 0 20 20"
                                                     fill="currentColor"
                                                     aria-hidden="true">
                                                    <path
                                                ...
                                                <!-- Collapse icon, show/hide based on section open state. -->
                                                <svg class="h-5 w-5 collapse-icon"
                                                     viewBox="0 0 20 20"
                                                     fill="currentColor"
                                                     aria-hidden="true">
                                                    <path fill-rule="evenodd"
                                    ...
                                    <!-- Filter section, show/hide based on section state. -->
                                    <div class="pt-6 transition ease-in-out duration-200 transform opacity-100 scale-95"
                                         id="filter-section-0">
                                        <div class="space-y-4">
                                            <!-- between two numbers -->
                                            ...
                                            <div class="flex w-64 m-auto items-center h-32 justify-center">
                                                <div class="py-1 relative min-w-full">
                                                    <div class="h-2 bg-gray-200 rounded-full">
                                                        ...
                                                        <div
                                                             class="absolute text-gray-800 -ml-1 bottom-0 left-0 -mb-6">
                                                            $ 8</div>
                                                        <div
                                ...
                                <div class="border-b border-gray-200 py-6">
                                    <h3 class="-my-3 flow-root">
                                        ...
                                        <button type="button"
                                                ...
                                                aria-expanded="false">
                                            <span class="font-large text-gray-900">Categorias</span>
                                            <span class="ml-6 flex items-center">
                                                <!-- Expand icon, show/hide based on section open state. -->
                                                <svg class="h-5 w-5"
                                                     viewBox="0 0 20 20"
                                    ...
                                    <!-- Filter section, show/hide based on section state. -->
                                    <div class="pt-6 transform opacity-100 scale-95 h-full"
                                         id="filter-section-1">
                                        <div class="space-y-4">
                                            <p class="text-sm">Produtos</p>
                                            @foreach ($entries['products']->categories as $category)
                                                <div class="flex items-center">
                                                    <input id="filter-category-0"
                                                           name="category[]"
                                                           value="new-arrivals"
                                                           type="checkbox"
                                                           class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                        ...
                                        <div class="space-y-4 mt-6">
                                            ...
                                            @foreach ($entries['services']->categories as $category)
                                                <div class="flex items-center">
                                                    <input id="filter-category-0"
                                                           name="category[]"
                                                           value="new-arrivals"
                            ...
                            <script type="module">
                                $(document).ready(function() {
                                    ...
                                    const dropdownMenuButton = $('div[aria-labelledby="menu-button"]');
                                    $(menuButton).on('click', function () {
                                        $(dropdownMenuButton).toggleClass('transition ease-in-out duration-200 transform opacity-0 scale-95 transform opacity-100 scale-100');
                                    })

                                    $('.sidebar-dropdown').on('click', function (e) {
                                        const ariaControls = $(e.currentTarget).attr('aria-controls');
                                            
                                        $(`#${ariaControls}`).toggleClass('h-0 transform opacity-0 scale-100 transform opacity-100 scale-0 -z-50');
                                        setTimeout(() => {
                                            $(`#${ariaControls}`).toggleClass('hidden')
                                        }, 100);
                                    })
                                })
                            </script>
                            <div class="lg:col-span-3">
                                        ...
                                        <div
                                            ...
                                            @foreach ($entries['products'] as $product)
                                                <article
                                                    ...
                                                    <div class="mt-1 p-2">
                                                        <a
                                                           href="{{ route('store.product.show', ['companySlug' => $product->company_slug, 'productSlug' => $product->slug, 'id' => $product->id]) }}">
                                ...
                                @endif
                                <!-- Service grid -->
                                @if (!empty($entries['services']->items()))
                                    <div class="service-grid my-10">
                                        <h2>Serviços</h2>
                                        <div
                                             class="grid max-w-6xl grid-cols-1 gap-6 p-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3">
                                            @foreach ($entries['services'] as $service)
                                                <article
                                                         class="rounded-xl bg-white shadow-lg hover:shadow-xl duration-300 ">
                                                    ...
                                                    <div class="mt-1 p-2">
                                                        <a
                                                           href="{{ route('store.service.show', ['companySlug' => $service->company_slug, 'serviceSlug' => $service->slug, 'id' => $service->id]) }}">
                                                            ...
                                                            <a
                                                               href="{{ route('store.service.show', ['companySlug' => $service->company_slug, 'serviceSlug' => $service->slug, 'id' => $service->id]) }}">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <button class="text-sm">Ver serviço</button>
                                                                </div>
                                                            </a>
                                                        </div>
                                                    </div>
                                ...
                                @endif
                                <!-- Companies grid -->
                                @if (!empty($entries['companies']->items()))
                                    <div class="company-grid my-10">
                                        <h2>Parceiros</h2>
                                        <div
                                             class="grid max-w-6xl grid-cols-1 gap-6 p-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3">
                                            @foreach ($entries['companies'] as $company)
                                                @if ($company->status === 'active')
                                                    <article
                                                        ...
                                                        <div
                                                             class="relative flex items-end overflow-hidden rounded-xl max-h-[250px]">
                                                            <img src="{{ $company->image ? asset('storage/' . $company->image) : 'images/default.png' }}"
                                                                 class="h-[250px] object-cover"
                                                                 alt="Hotel Photo" />
                                                        ...
                                                        <div class="mt-1 p-2">
                                                            <a
                                                               href="{{ route('store.company.show', [
                                                                   'companySlug' => $company->slug,
                                                                   'id' => $company->id,
                                                               ]) }}">
                                                                <h2 class="text-slate-700">{{ $company['name'] }}</h2>
                                                                <p class="mt-1 text-sm text-slate-400">
                                                            ...
                                                            <div class="mt-3 flex items-end justify-between">
                                                               ...
                                                               hover:bg-blue-600">
                                                                        ...
                                                                        <button class="text-sm">Ver Empresa</button>
                                                                    </div>
                                                                </a>
                                                            </div>
                                                        </div>
