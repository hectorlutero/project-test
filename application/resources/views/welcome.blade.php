    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <img style="width: 150px" src="https://cdn-icons-png.flaticon.com/512/2415/2415292.png">
                <h1 style="color:white">PedeQueVem! - A sua plataforma </h1>
            </div>
                    ...
                    {{-- <a href="https://laravel.com/docs"
                       class="scale-100 p-6 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 bg-red-500">
                                Documentation
                            </h2>
            ...
            <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                ...
                <div class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">
                    PedeQueVem! - Todos os direitos - {{ date('Y')}}
                </div>
            </div>
        </div>
    </div>
